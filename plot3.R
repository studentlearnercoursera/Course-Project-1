plot3 = read.table("household_power_consumption.txt",skip=1,sep=";")
names(plot3) <- c("Date","Time","Global_active_power","Global_reactive_power","Voltage","Global_intensity","Sub_metering_1","Sub_metering_2","Sub_metering_3")
subplot3 <- subset(plot3,plot3$Date=="1/2/2007" | plot3$Date =="2/2/2007")
...
plot(subplot3$Time,subplot3$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering",main="Energy sub-metering")
